...
public class LabDeviceMainBean {
    int lab_room_id;
    int lab_device_id;
    ...
    public LabDeviceMainBean(int lab_room_id, int lab_device_id, String lab_device_name, String lab_device_image_url, String lab_device_supplier, String lab_device_introduct, String lab_device_video_url) {
    ...
    public LabDeviceMainBean(int lab_room_id, int lab_device_id, String lab_device_name, String lab_device_image_url) {
        this.lab_room_id = lab_room_id;
        this.lab_device_id = lab_device_id;
        this.lab_device_name = lab_device_name;
        this.lab_device_image_url = lab_device_image_url;
