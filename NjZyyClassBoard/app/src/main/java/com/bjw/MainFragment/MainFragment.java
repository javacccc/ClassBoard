...
import com.bjw.DynamicInfo.DynamicInfoMain;
import com.bjw.LabDeviceInfo.LabDeviceMain;
import com.bjw.R;
import com.bjw.Service.ChangeTimeService;
import com.bjw.Service.GetCardInfoService;
import com.bjw.Service.SerialService;
import com.bjw.Service.TimerService;
...
public class MainFragment extends FragmentActivity {
    ...
    private DynamicInfoMain firstFragment;
    private LabDeviceMain secondFragment;
    private third thirdFragment;
    private fourth fourthFragment;
    Intent intentForGetnum,intentForTime,intentForChangeTime,intentforGetcardinfo,intentforCheckInterNet;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerForExit();
        //开启串口，卡号，定时器，改变时间的服务
//        intentForGetnum=new Intent(getBaseContext(),SerialService.class);
//        getBaseContext().startService(intentForGetnum);
//        intentForTime=new Intent(getBaseContext(),TimerService.class);
...
//        intentforGetcardinfo=new Intent(getBaseContext(),GetCardInfoService.class);
...
//                mPageVp.setAdapter(mFragmentAdapter);
    ...
    private void init() {
        firstFragment = new DynamicInfoMain();
        secondFragment = new LabDeviceMain();
...
//            Intent intent=new Intent(getBaseContext(),ChooseLabBeforeLoginAc.class);
