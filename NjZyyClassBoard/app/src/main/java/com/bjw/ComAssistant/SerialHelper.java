...
//						BeanForSerial ComRecData = new BeanForSerial(cardNum, 520);
...
//					}
					...
					*************************************************/
					...
					listforcard.clear();
					BeanForSerial ComRecData = new BeanForSerial(list, FLAG1);
					onDataReceived(ComRecData);
				}
				}
				} catch (Throwable e){
	...
	protected abstract void onDataReceived(BeanForSerial ComRecData);
}