...
public class LessonFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState){
        ...
        View chatView = inflater.inflate(R.layout.fragment_right_lesson, container,false);
        return chatView;
    }
    @Override
    ...
    public void onStart() {
        ...
        int[] to = {  R.id.siple_tv1,R.id.siple_tv2,R.id.siple_tv3,R.id.siple_tv4} ;
         lessonBelowAdapter = new LessonBelowAdapter(getActivity(), list,R.layout.activity_right_lesson_list_item, from, to) ;
...
//            new BigInteger("c01a2033", 16).toString();//将16进制转换为需要的10进制数
            cardNum = new BigInteger(cardNum, 16).toString();
