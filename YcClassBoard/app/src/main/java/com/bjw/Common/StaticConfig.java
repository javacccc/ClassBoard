...
//    班牌后台的地址
//    F:\导入项目\ycitlims-clone\classCard\back
...
//    public  static String remoteUrl="https://192.168.1.184:899/ycitlims/";
    ...
    public  static String TimeToUpdate="1:01:00";//动态更新数据操作的时间
    ...
    public static boolean isLabOrderFragment=false;//判断当前的页面是否是实验室预约界面，从而来区分当前的刷卡是考勤还是实验室预约
    public static boolean isLabLessonFragment=true;//判断当前的页面是否是实验室预约界面，从而来区分当前的刷卡是考勤还是实验室预约
}
